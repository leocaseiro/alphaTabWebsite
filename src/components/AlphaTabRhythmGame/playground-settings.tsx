  ...
  return [
    {
      ...
      settings: [
        ...
        factory.numberRangeNegativeDisabled(
          "Bars per System",
          "display.barsPerRow",
          -1,
          20,
    ...
    },
    {
      ...
      settings: [
        ...
        factory.toggle(
          "Small Grace Notes in Tabs",
          "notation.smallGraceTabNotes",
        ),
        factory.toggle(
          "Extend Bend Arrows on Tied Notes",
          "notation.extendBendArrowsOnTiedNotes",
        ),
        factory.toggle(
          "Extend Line Effects to Beat End",
    ...
    },
    {
      ...
      settings: [
        ...
        factory.numberInput(
          "Vibrato Beat Wide Length",
          "player.vibrato.beatWideLength",
          0.1,
          undefined,
          0.1,
        ),
    ...
    },
    {
      ...
      settings: [
        ...
        },
        {
          ...
          control: {
            type: "enum-dropdown",
            enumType: alphaTab.model.BracketExtendMode,
          },
        },
        {
        ...
        },
        {
          ...
          control: {
            type: "enum-dropdown",
            enumType: alphaTab.model.TrackNamePolicy,
          },
        },
        {
        ...
        },
        {
          ...
          control: {
            type: "enum-dropdown",
            enumType: alphaTab.model.TrackNameMode,
          },
        },
        {
          ...
          control: {
            type: "enum-dropdown",
            enumType: alphaTab.model.TrackNameOrientation,
          },
        },
        {
...
const ColorPicker: React.FC<ColorPickerSchema & ControlProps> = ({
  inputId,
  getValue,
  setValue,
}) => {
  ...
  const [color, setColor] = useState(
    getValue(settings) as alphaTab.model.Color,
  );
  ...
  return (
    <div className={styles["color-picker"]}>
      <div
        className={`dropdown dropdown--right ${isOpen ? "dropdown--show" : ""}`}
      >
        <button
          type="button"
...
const FontPicker: React.FC<FontPickerSchema & ControlProps> = ({
  inputId,
  getValue,
  setValue,
}) => {
  ...
  return (
    <input
      ...
      onBlur={(e) => {
        const c = alphaTab.model.Font.fromJson(
